...
const handleSubmit = async (e) => {
  ...
  const renderInputField = (field) => (
    <div key={field.name}>
      <label 
      className={field.icon ? AddCarPageStyles.labelWithIcon : AddCarPageStyles.label
      }
      >
        {field.icon}
        {field.name}
  ...
  const renderSelectField = (field) => (
    <div key={field.name}>
      ...
      name={field.name} value={data[field.name]} onChange={handleChange} className={AddCarPageStyles.select}>
        ...
        <form onSubmit={handleSubmit} className={AddCarPageStyles.form}>
          <div className={AddCarPageStyles.formGrid}>
            ...
            <div className={AddCarPageStyles.formColumn}>
              ...
              <div>
                <label 
                className={AddCarPageStyles.label}>Description</label>
                <textarea 
                  required 
                  name="description" 
                  ...
                  onChange={handleChange} 
                  rows="4" 
                  className={`${AddCarPageStyles.textarea} min-h-28 !bg-gray-900/[0.4] !text-gray-200 placeholder-gray-400`} 
