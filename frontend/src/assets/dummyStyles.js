...
// styles used by MyBookings page
export const myBookingsStyles = {
  pageContainer: "min-h-screen bg-black text-white py-8 px-4",
  title: "text-3xl font-bold text-white",
  subtitle: "text-gray-400 mt-2",
  filterButton: (active) => `${active ? 'bg-orange-500 text-white' : 'bg-gray-800 text-gray-200'} px-3 py-2 rounded-md`,
  bookingCard: "bg-gray-800/60 rounded-2xl overflow-hidden border border-gray-700 p-0",
  cardImageContainer: "w-full h-48 rounded-t-2xl overflow-hidden",
  cardImage: "w-full h-full object-cover",
  cardContent: "p-4 sm:p-5",
  cardHeader: "flex justify-between items-start mb-3",
  carTitle: "text-lg font-semibold text-white",
  carSubtitle: "text-sm text-gray-400",
  priceText: "text-base sm:text-lg font-bold text-orange-400",
  daysText: "text-xs text-gray-400",
  detailSection: "mt-3 space-y-2 pb-3 border-b border-gray-700",
  detailItem: "flex items-start gap-2",
  detailIcon: "text-orange-400 mt-0.5 text-sm",
  detailLabel: "text-xs text-gray-400",
  detailValue: "text-sm text-white",
  cardActions: "mt-4 flex items-center gap-3",
  viewDetailsButton: "flex-1 px-4 py-2.5 text-sm bg-gray-700 text-gray-200 rounded-md hover:bg-gray-600 transition-colors inline-flex items-center justify-center gap-2 font-medium",
  bookAgainButton: "flex-1 px-4 py-2.5 bg-orange-500 text-white rounded-md inline-flex items-center justify-center gap-2 text-sm hover:bg-orange-600 transition-colors font-medium",
  modalOverlay: "fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4",
  modalContainer: "max-w-2xl w-full max-h-[90vh] overflow-y-auto",
  modalContent: "bg-gray-900/90 rounded-2xl p-4 sm:p-6 border border-gray-700",
  modalHeader: "flex justify-between items-center mb-4 gap-2",
  modalTitle: "text-lg sm:text-xl font-semibold",
  cancelButton: "px-3 py-2 text-sm bg-red-500 text-white rounded-md hover:bg-red-600 transition-colors",
  modalCloseButton: "px-3 py-2 bg-gray-700 text-white rounded-md hover:bg-gray-600 transition-colors text-lg leading-none",
  modalGrid: "grid grid-cols-1 md:grid-cols-2 gap-4 mb-4",
  carImageModal: "w-full h-32 sm:h-40 object-cover rounded-lg",
  carTags: "flex items-center gap-2 mt-2 flex-wrap",
  carTag: "px-2 py-1 bg-gray-800 text-xs rounded-full text-orange-300",
  infoGrid: "grid grid-cols-2 gap-2 mt-2 text-xs",
  infoLabel: "text-xs text-gray-400",
  infoValue: "text-xs text-white",
  infoBox: "bg-gray-800/50 p-3 rounded-lg border border-gray-700",
  priceValue: "text-sm font-bold text-white",
  infoCard: "bg-gray-800/50 p-2 sm:p-3 rounded-lg border border-gray-700 text-sm",
  infoRow: "flex justify-between items-center text-xs",
  infoDivider: "border-t border-gray-700 pt-1",
  modalActions: "mt-4 flex justify-end gap-2",
  closeButton: "px-3 py-2 text-sm bg-gray-700 text-white rounded-md hover:bg-gray-600 transition-colors",
  modalBookButton: "px-3 py-2 text-sm bg-orange-500 text-white rounded-md inline-flex items-center gap-2 hover:bg-orange-600 transition-colors",
  statsCard: "bg-gray-800/50 p-4 rounded-lg text-center",
  statsValue: (color) => `text-2xl font-bold ${color || 'text-white'}`,
  statsLabel: "text-sm text-gray-400",
  loadingSpinner: "w-12 h-12 border-4 border-t-orange-500 border-gray-700 rounded-full animate-spin",
  errorContainer: "bg-red-900/60 p-4 rounded-lg text-white",
  errorText: "text-sm",
  retryButton: "mt-2 px-3 py-2 bg-orange-500 text-white rounded-md",
  emptyState: "text-center py-12",
  emptyIconContainer: "w-20 h-20 rounded-full bg-gray-800 mx-auto flex items-center justify-center",
  emptyIcon: "text-3xl text-orange-400",
  emptyTitle: "text-xl font-semibold mt-4",
  emptyText: "text-gray-400 mt-2",
  browseButton: "mt-4 inline-flex items-center gap-2 px-4 py-2 bg-orange-500 text-white rounded-md",
};
